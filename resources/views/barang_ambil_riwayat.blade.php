...
@section('title', 'Riwayat Barang Consumable')
                        ...
                        @forelse ($item as $key => $m)
                          ...
                          <tr>
                            ...
                            <td class="flex-button">
                              <a href="{{route('barang.ambil.kembali', ['id' => $m->id])  }}" class="btn btn-success" data-placement="top" title="Kembalikan Data Barang">
                              ...
                              <a href="#" class="btn btn-danger" onclick="alertDelete($(this).find('form'), true)" data-toggle="tooltip" data-placement="top" title="Hapus">
                                ...
                                <form action="{{route('barang.ambil.destroy')}}" method="POST">
                                  @csrf
                                  @method('delete')
                          ...
                          <tr>
                            <td colspan="7">
                              <div class="empty-state" data-height="400" style="min-height: 400px;">
                                ...
                                <h2>Tidak ada riwayat hapus dari barang consumable!</h2>
                              </div>
                            </td>
                          </tr>
